...
const Home = () => {
    return (
        <div class="hero h-[70vh] w-4/5 mx-auto bg-accent mt-16 mb-20 ">
  <div class="hero-content flex-col lg:flex-row ">
  <div>
      <h1 data-aos="fade-right" data-aos-duration="1000" data-aos-delay="200" class="text-4xl font-bold ">Best Collections </h1>
      <h1 data-aos="fade-right" data-aos-duration="900" data-aos-delay="400" class="text-4xl font-bold">for Women's </h1>
    ...
    <img src={shoppingGirl} class="h-[400px]  w-[50vh] mt-[-20px]" alt='' />
    </div>
